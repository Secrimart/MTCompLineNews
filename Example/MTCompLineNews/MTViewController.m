...
//  MTCompLineNews
//
//  Created by rstx_reg@aliyun.com on 04/11/2018.
...
- (NSArray<MTComponent *> *)componentLocalConfigData {
    ...
    [dict setValue:@"MTCompLineNewsVC" forKey:@"componentVCName"];
...
- (NSArray<NSDictionary *> *)componentServiceData {
    ...
    [busData setObject:@"page1" forKey:@"newsID"];
    [busData setObject:@"*文本统计: 1231222 次" forKey:@"title"];
    ...
    [busData1 setObject:@"*文件统计: 1231222 次" forKey:@"title"];
    ...
    [busData2 setObject:@"*访问量统计: 1231222 次" forKey:@"title"];
